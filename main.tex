	...
	\section{How to play}{%
		...
		\subsection{Deal}{%
			...
			\subsubsection{Winning}{%
				The winner is the player who first scores the winning score. The winning score starts at $13$, but $2$ is subtracted from it every time all players have dealt one deal each. A player must win by completing a bid and can therefore not win solely because the winning score just decreased.
			}
		}
	}
