	...
	\begin{center}
		\begin{tabularx}{\textwidth}{
			...
			cc|X
				...
				{min 5}
				{%
					Spelföraren bestämmer trumffärg. Såvida spelföraren inte enbart besitter trumfkort, får denne inte spela spela ut i trumffärgen före trumf redan har spelats.
				}
