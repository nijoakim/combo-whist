...
\begin{table}
	...
	\begin{center}
		\begin{tabularx}{\textwidth}{lcccc|X}
				...
				{varierar}
				{%
					Före spelets början gissar spelföraren på en möjlig mängder stick denne kommer att ta hem. Hen måste ta hem den mängd som gissades.
				}
				...
				{min 5}
				{%
					Spelaren till vänster om spelföraren bestämmer trumffärg, men först får de andra icke-spelförarna säge vilken trumffärg de föredrar och hur mycket de föredrar denna på en skala från $1$ till $10$ (utan motivering).
				}
