...
\begin{table}
	...
	\begin{center}
		\begin{tabularx}{\textwidth}{lcccc|X}
				...
				{alla}
				{%
					Om budet genomförs får spelföraren lika många poäng som kombinations-budets värde. Skulle dessutom kombinations-budets värde vara $13$ eller högre och resultera i att spelföraren vinner spelet omedelbart så erhåller denne rätten att titulera sig \emph{Obesudlad Mästare av Kombinations-Whist} under resten av sitt liv. Om spelföraren tar hem färre än hälften av sticken förlorar denne dubbelt som många poäng som hen annars skulle ha förlorat.
				}
		\end{tabularx}
	\end{center}
\end{table}
