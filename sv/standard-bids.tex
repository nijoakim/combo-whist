	...
	\begin{center}
		\begin{tabularx}{\textwidth}{
			...
			cc|X
				...
				{13}
				{%
					Om budet går hem får spelföraren lika många poäng som kombinations-budets värde (rundat nedåt till närmaste heltal). Skulle dessutom kombinations-budets värde vara 13 eller högre vinner spelföraren spelet omedelbart oavsett poängställning. När detta inträffar erhåller dessutom spelföraren rätten att titulera sig \emph{Obesudlad~Mästare~av~Kombinations-Whist} under resten av sitt liv.
				}
		\end{tabularx}
	\end{center}
\end{table}
