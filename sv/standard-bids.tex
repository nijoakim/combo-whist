...
\begin{table}
	...
	\begin{center}
		\begin{tabularx}{\textwidth}{lcccc|X}
				...
				{min 5}
				{%
					Alla spelare väljer ett kort var. Dessa kort blandas och delas sen ut igen, denna gång med bildsidorna uppåt. Färgen på det kort som spelföraren får är trumffärgen. Alla spelare behåller de kort de just fått.
				}
