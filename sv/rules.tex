...
\begin{document}
	...
	En standard-kortlek med 52 kort, samt penna och papper. (Det är \emph{valfritt} att använda hjälpkorten då de enbart används organisera spelarnas tankar utan att ha någon reell effekt på spelet.)
