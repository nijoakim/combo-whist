	...
	\section{Hur man spelar}{%
		...
		\subsection{Given}{%
			...
			\subsubsection{Poängberäkningen}{%
				Efter att spelet är klart så får spelföraren ett antal poäng baserat på vilket kombinations-bud som bjöds och huruvida detta bud gick hem. Om budet gick hem får spelföraren det antal poäng som specificeras ``Poäng''-kolumnen för standardbudet. Om budet inte gick hem så förlorar spelföraren 2 poäng. En spelare kan anta en negativ poängsumma. Om en spelare antar en poängsumma lägre än -5, så tillåts denne inte längre att bjuda i budgivningar. Hen får dock 1 gratispoäng när den given är klar (även om ingen bjuder och det blir omgiv).
			}
