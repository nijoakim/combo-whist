...
\ifdefined\varDev
	\date{Utvecklarversion (baserad på version \varVersion-\varLanguage) --- \today}
\else
...
\begin{document}
	...
	\section{Hur man spelar}
		\subsection{Förberedelser}
			...
			Om det bara finns 3 spelare, ta ut $\spadesuit 6$, samt alla 9:or, 8:or och 7:or från leken.
