...
\begin{document}
	...
	\section{Övrigt}
		...
		\subsection{Versionsnummer}
			...
			\begin{verbatim}
				<överordnad version> . <underordnad version> . <revision> - <språk>
			\end{verbatim}

			Den överordnade versionen ökar enbart när omvälvande ändringar görs i spelet. Det är osannolikt att detta nånsin kommer att hända.
