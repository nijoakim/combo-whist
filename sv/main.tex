	...
	\section{Hur man spelar}
		...
		\subsection{Given}
			...
			\subsubsection{Vem som vinner}
				\label{sec:winning}
				Det finns två varianter av hur vinnaren ska bestämmas i Kombinations-Whist: \emph{klassisk} och \emph{begränsad}.
				...
				\paragraph{Begränsad:}
					Ett förutbestämt antal grund-rundor ska spelas (förslagsvis 3), där en runda innefattar att alla spelare har varit giv en gång vardera. När grund-rundorna har spelats vinner näste spelare som går hem med ett bud som resulterar i att denne uppnår enskilt flest poäng. För att förtydliga kan en person vinna i samband med att sista grund-rundan just spelats färdigt.
