...
\begin{table}
	...
	\begin{center}
		\begin{tabularx}{\textwidth}{
			...
			{%
				Spelföraren väljer en färg som är \emph{pestfärgen}. Spelföraren får inte bli \emph{förpestad}; det vill säga, får inte ta hem enskilt flest kort (notera: \emph{ej} stick) i pestfärgen, såvida inte denne blir \emph{hedervärt förpestad} och tar hem hela pestfärgen, i vilket fall denne får 1 hedervärt extra-poäng.
			}
