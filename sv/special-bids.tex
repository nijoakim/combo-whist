...
\begin{table}
	...
	\begin{center}
		\begin{tabularx}{\textwidth}{lS[table-number-alignment=center]p{3cm}|X}
			...
			{---}
			{%
				Om budet går hem markeras det med ett P, en \emph{potential}, i spelförarens kolonn och denne blir så kallad \emph{potentiell}. En spelare kan endast inneha ett P i sin kolonn.
			}
