...
\begin{table}
	...
	\begin{center}
		\begin{tabularx}{\textwidth}{lcp{3cm}|X}
			...
			{---}
			{%
				Detta bud får endast bjudas om spelföraren har gått hem med specialbudet \emph{Potential}, det vill säga om spelföraren är \emph{potentiell}. När det bjuds stryks det P som spelföraren har samlat på sig genom att gå hem med \emph{Potential} och spelföraren slutar vara potentiell.
			}
