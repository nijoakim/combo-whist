...
\begin{table}
	...
	\begin{center}
		\begin{tabularx}{\textwidth}{
			...
			{---}
			{%
				Detta bud får endast bjudas om spelföraren har minst ett P i sin kolonn (vilket denne kan få genom att gå hem med budet \emph{Potential}). När detta bud ingår i det högsta kombinations-budet stryks spelförarens tidigare insamlade P.
			}
