...
\begin{table}
	...
	\begin{center}
		\begin{tabularx}{\textwidth}{
			...
			{---}
			{%
				Om budet går hem markeras det med ett P, en \emph{potential}, i spelförarens kolumn.
			}
			...
			{%
				Spelföraren väljer en färg som är \emph{pestfärgen}. Spelföraren får inte bli \emph{förpestad}; det vill säga, får inte ta hem enskilt flest kort (notera: \emph{ej} stick) i pestfärgen, såvida inte denne blir \emph{hedervärt förpestad} och tar hem hela pestfärgen, i vilket fall spelföraren får 1 hedervärt extra-poäng.
			}
			...
			{---}
			{%
				När detta bud ingår i det högsta kombinations-budet stryks ett av spelförarens tidigare insamlade P:n. Skulle spelförarer in ha några P:n markeras detta med ett $\bar{\text{P}}$ (anti-P) in dennes kolumn. En spelare kan inte vinna med ett $\bar{\text{P}}$ i dennes kolumn förutom genom en \emph{Skamvinst} (se stycket \textit{\nameref{sec:winning}}).
			}
