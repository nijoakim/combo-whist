...
\begin{table}
	...
	\begin{center}
		\begin{tabularx}{\textwidth}{
			...
			{---}
			{%
				Spelföraren får en gång under spelets gång utropa ``Veto!'' just efter att en spelare just spelat ett kort, men före nästa spelare har spelat dess kort. Om det är möjligt måste då det spelade kortet bytas ut mot ett annat. Vetot förbrukas även om det inte var möjligt att byta kort.
			}
