...
\section{Specialbud}
	\begin{center}
		\begin{tabularx}{\textwidth}{
			...
			{---}
			{%
				Om budet budas i kombination med ett trumf-bud some inte är \emph{Grill} är värdet 3, men annars 1. Före spelet börjar skickar alla utom spelföraren 3 kort till spelaren till höger (spelföraren hoppas över).
			}
