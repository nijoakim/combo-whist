...
\begin{table}
	...
	\begin{center}
		\begin{tabularx}{\textwidth}{
			...
			{---}
			{%
				Om budet går hem markeras det med ett P, en \emph{potential}, i spelförarens kolumn. Värdet på alla spelförarens framtida kombinationsbud ökar med \sfrac{1}{2} enhet för varje P i dennes kolumn.
			}
			...
			{\nonTrump, Grill}
			{%
				Före spelet börjar skickar alla utom spelföraren 4 kort till spelaren till höger (spelföraren hoppas över). Om \emph{Skick} har budats så skickas \emph{Skick}-korten före \emph{Mästarskick}-korten.
			}
