...
\begin{table}
	...
	\begin{center}
		\begin{tabularx}{\textwidth}{
			...
			{---}
			{%
				If this bid is completed it is marked by a P, a \emph{potential}, in the declarer's column. If the declarer has a $\bar{\text{P}}$ (anti-P) in their column, that $\bar{\text{P}}$ is instead crossed out.
			}
			...
			{---}
			{%
				When this bid is part of the highest combo bid, one P, aquired by completing \emph{Potential}, is crossed out from the declarer's column. If the declarer has no Ps, an $\bar{\text{P}}$ (anti-P) is instead marked in the their column. A player can not win with an $\bar{\text{P}}$ in their column, except by a \emph{Win of Shame} (see the \textit{\nameref{sec:winning}} section).
			}
