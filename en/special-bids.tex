...
\begin{table}
	...
	\begin{center}
		\begin{tabularx}{\textwidth}{
			...
			{---}
			{%
				At the end of the game 1 virtual trick is added to or subtracted from the declarer's stick count in sucha a way that it disfavors them. If the bid is completed, the declarer scores 1 extra point.
			}
