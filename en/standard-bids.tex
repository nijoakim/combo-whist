	...
	\begin{center}
		\begin{tabularx}{\textwidth}{
			...
			cc|X
				...
				{min 5}
				{%
					The declarer decides trump suit. Unless left with no other option, the declarer is not allowed to lead in the trump suit before trump has already been played.
				}
				...
				{13}
				{%
					*If the bid is completed, the declarer scores as many points as the combo bid is worth. In addition, in case the combo bid's worth is 13 or higher, the declarer immediately wins the game regardless of previous scores. When this occurs, in addition, the declarer earns the right to the title, \emph{Taintless~Master~of~Combo~Whist}, for the rest of their life.
				}
		\end{tabularx}
	\end{center}
\end{table}
