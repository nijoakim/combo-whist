...
\begin{table}
	...
	\begin{center}
		\begin{tabularx}{\textwidth}{lcccc|X}
				...
				{all}
				{%
					If the bid is completed, the declarer scores as many points as the combo bid's worth. In case the combo bid's worth is $13$ or higher and results in that declarer wins the game, the declarer earns the right to the title, \emph{Taintless Master of Combo Whist}, for the rest of their life. If the declarer brings home less than half of the tricks, they lose double the amount of points as they would otherwise have lost.
				}
		\end{tabularx}
	\end{center}
\end{table}
