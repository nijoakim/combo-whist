	...
	\begin{center}
		\begin{tabularx}{\textwidth}{
			...
			cc|X
				...
				{13}
				{%
					*If the bid is completed, the declarer scores as many points as the combo bid's worth. In addition, in case the combo bid's worth is 13 or higher, the declarer immediately wins the game regardless of previous scores. When this occurs, in addition, the declarer earns the right to the title, \emph{Taintless~Master~of~Combo~Whist}, for the rest of their life.
				}
		\end{tabularx}
	\end{center}
\end{table}
