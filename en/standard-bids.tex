	...
	\begin{center}
		\begin{tabularx}{\textwidth}{
			...
			cc|X
				...
				{varies}
				{%
					The declarer must bring home fewer tricks during the last half of the game than during the first. Since the two halves are can not be split equally large, the last half is shorter than the first.
				}
